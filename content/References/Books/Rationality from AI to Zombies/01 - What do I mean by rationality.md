...
![[Attachments/Excalidrawings/1 - What Do I Mean By Rationality - rationality from ai to zombies.png]]
...
- *Epistemic rationality* is about building accurate (mental) maps, in order to improve the correspondence between your beliefs (the map) and the reality (the territory). The example he provides is about locating in your mind the position of the objects in your room: if your model says that there is a bookcase where no bookcase exists, your model might be unsynchronized with the reality. 
  It can also be about uncertain facts or indirect evidence (e.g. you can assert/believe  lost the Leipzig battle, even if you've never met him).

- *Instrumental rationality* is about steering reality, choosing actions that lead to outcomes ranked higher in your preferences. It doesn't mean being selfish or put other people down: your preferences can also be about sharing/caring.
